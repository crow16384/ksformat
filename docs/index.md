...
- **In R:** run
  [`ksformat_cheatsheet()`](reference/ksformat_cheatsheet.md) to open
  the cheat sheet in your browser (HTML), or
  `ksformat_cheatsheet("pdf")` for the PDF.
- **In this repo:** [HTML](inst/doc/ksformat-cheatsheet.md) \|
  [PDF](inst/doc/ksformat-cheatsheet.pdf)

## Function reference

| Area | Functions |
|----|----|
| **Creation** | [`fnew()`](reference/fnew.md), [`finput()`](reference/finput.md), [`fnew_bid()`](reference/fnew_bid.md), [`fnew_date()`](reference/fnew_date.md), [`fparse()`](reference/fparse.md), [`e()`](reference/e.md) |
| **Application** | [`fput()`](reference/fput.md), [`fputn()`](reference/fputn.md), [`fputc()`](reference/fputc.md), [`fput_all()`](reference/fput_all.md), [`fput_df()`](reference/fput_df.md) |
| **Reverse** | [`finputn()`](reference/finputn.md), [`finputc()`](reference/finputc.md) |
| **Library** | [`format_get()`](reference/format_get.md), [`fprint()`](reference/fprint.md), [`fclear()`](reference/fclear.md), [`fexport()`](reference/fexport.md), [`fimport()`](reference/fimport.md), [`format_library_app()`](reference/format_library_app.md) |
| **Utilities** | [`is_missing()`](reference/is_missing.md), [`range_spec()`](reference/range_spec.md) |
| **Documentation** | [`ksformat_cheatsheet()`](reference/ksformat_cheatsheet.md) — open cheat sheet |
